            ...
            <table class="table , text-center">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a href="{{route('product.danhmuc')}}" class="btn btn-success">them moi</a>
                        </th>
                    </tr>
                </thead>
                <tbody>
                  @foreach ($products as $product )
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route('product.del',$product->id)}}" method="post" onclick="return confirm('ban co muon xoa khong ?')">
                                @csrf
                                @method('delete')
